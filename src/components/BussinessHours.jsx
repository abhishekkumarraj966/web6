  ...
  return (
    <div className="bg-[#F3F5F7]">
      ...
      <div class=" mx-4 px-4 sm:mx-[20%] lg:mx-[30%] pt-10  pb-14 ">
        <div className="">
          <div className="border-2 sm:border-2 border-[#FDCF24] rounded-[10px] bg-[#000000] sm:mx-20 px-4 sm:px-0">
            <div className=" mx-1 lg:ml-[45px] sm:mx-[25px] lg:my-[32px] sm:my-[25px] my-[15px] text-[#FDCF24]">
