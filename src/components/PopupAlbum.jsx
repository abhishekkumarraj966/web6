...
import gl4 from "./assites/gl4.png";
import gl5 from "./assites/gl1.png";
let imagarr = [ gl1,  gl2,  gl3,  gl4,  gl5,  gl2]; // if you want to add some image then , gice url in this array
